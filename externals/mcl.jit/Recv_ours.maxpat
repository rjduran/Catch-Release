	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 599.0, 90.0, 681.0, 353.0 ],
						"bglocked" : 0,
						"defrect" : [ 599.0, 90.0, 681.0, 353.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "write onehand_SFU.mov 60. raw max 600",
									"id" : "obj-6",
									"outlettype" : [ "" ],
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"numinlets" : 2,
									"patching_rect" : [ 281.0, 24.0, 235.0, 18.0 ],
									"numoutlets" : 1
								}
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "write FACE_SFU.mov 60. raw max 600",
									"id" : "obj-5",
									"outlettype" : [ "" ],
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"numinlets" : 2,
									"patching_rect" : [ 293.0, 53.0, 244.0, 18.0 ],
									"numoutlets" : 1
								}
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "write walkby_SFU.mov 60. raw max 600",
									"id" : "obj-4",
									"outlettype" : [ "" ],
									"fontname" : "Arial",
									"fontsize" : 11.595187,
...
, 							{
								"box" : 								{
									...
									"fontsize" : 18.0,
									"numinlets" : 2,
									"patching_rect" : [ 163.0, 65.0, 46.0, 25.0 ],
									"numoutlets" : 1
								}
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "write movearound_SFU.mov 60. raw max 600",
									"id" : "obj-41",
									"outlettype" : [ "" ],
									"fontname" : "Arial",
									"fontsize" : 11.595187,
									"numinlets" : 2,
									"patching_rect" : [ 305.0, 83.0, 246.0, 18.0 ],
									"numoutlets" : 1
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-47", 0 ],
									"hidden" : 0,
									"midpoints" : [ 172.5, 144.5, 51.5, 144.5 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.net.recv @ip 169.284.106.114 @port 7000",
					"id" : "obj-25",
					"outlettype" : [ "jit_matrix", "", "" ],
					"fontname" : "Arial Bold",
					"fontsize" : 13.0,
