...
using SPIHT with arithmetic coding for MacOS
...
Files included:
mcl.jit.spihtaritenc.mxo - encoder
mcl.jit.spihtaritdec.mxo - decoder
spihtarit_enc_dec.maxpat - encoder/decoder demo patch
mac_send_aritenc.maxpat  - encoder+sender demo patch
mac_recv_aritdec.maxpat  - receiver+decoder demo patch
...
640x480 video, 0.5 bpp should be enough for reasonably high quality. For
320x240 video, around 0.8 bpp should be enough. Note that the bitrate 
...
The sender and receiver demo patches (win_send_aritenc.maxpat and 
win_recv_aritdec.maxpat) are similar to the two patches from Ref. 1. They show
